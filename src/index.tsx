 ...
 , trigger: 'on press'
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            styles:[`{ backgroundColor: "chocolate", height: "50px", }`],
      ...
      styles:[
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            functions:[async (...args) =>
 functions.funcGroup({ args, pass:{
 arrFunctions: [() => [ "sc.A2.listBox", "==", false ]]
 , trigger: 'on listen'
}})],            childrenItems:[(...args:any) => <Elements.FlatList2 pass={{
          elementProperties: [
            {}
      ...
      styles:[
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            functions:[async (...args) =>
 functions.funcGroup({ args, pass:{
 arrFunctions: [() => [ "sc.A5.listBox", "==", false ]]
 , trigger: 'on listen'
}})],            childrenItems:[(...args:any) => <Elements.FlatList2 pass={{
          elementProperties: [
            {}
  ...
  color: "#5C5F6A",
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            functions:[async (...args) =>
 functions.funcGroup({ args, pass:{
 arrFunctions: [() => [ "sc.A6.listBox", "==", true ]]
 , trigger: 'on listen'
}})],            childrenItems:[(...args:any) => <Elements.FlatList2 pass={{
          elementProperties: [
            {}
      ...
      styles:[
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            functions:[async (...args) =>
 functions.funcGroup({ args, pass:{
 arrFunctions: [() => [ "sc.A6.listBox", "==", false ]]
 , trigger: 'on listen'
}})],            childrenItems:[(...args:any) => <Elements.FlatList2 pass={{
          elementProperties: [
            {}
  ...
  color: "#5C5F6A",
        ...
        , (...args:any) => <Elements.ScrollBar pass={{
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            functions:[async (...args) =>
 functions.funcGroup({ args, pass:{
 arrFunctions: [() => [ "sc.A7.listBox", "==", true ]]
 , trigger: 'on listen'
}})],            childrenItems:[(...args:any) => <Elements.FlatList2 pass={{
          elementProperties: [
            {}
      ...
      styles:[
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            functions:[async (...args) =>
 functions.funcGroup({ args, pass:{
 arrFunctions: [() => [ "sc.A7.listBox", "==", false ]]
 , trigger: 'on listen'
}})],            childrenItems:[(...args:any) => <Elements.FlatList2 pass={{
          elementProperties: [
            {}
